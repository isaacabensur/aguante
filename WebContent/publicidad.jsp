...
<div id="cuerpo">
    ...
    <form name="registrarPublicidad" action="PublicidadServlet" method="post">
      <table width="100%" border="0" cellspacing="0" cellpadding="3">
        ...
        <tr>
          <td align="right" valign="middle"><label for="contenido">Contenido</label></td>
          <td>
          <input type="text" name="contenido" id="contenido" /></td>
        </tr>
        <tr>
        ...
        <tr>
          <td>&nbsp;</td>
          <td><br />            <input type="submit" name="registrar" id="registrar" value="Registrar" /></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
